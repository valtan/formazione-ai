...
OUT   = "/sessions/blissful-gallant-johnson/mnt/outputs/brochure_v27.pdf"
...
# eyebrow
T(M, 812, "PIAMARTA LAVORO E SVILUPPO — A.F.G.P.", "MonoB", 8, ACID, tracking=1.4)
T(W - M, 812, "FORMAZIONE AZIENDALE / AI GENERATIVA", "Mono", 8, MIST, align="r")
hline(M, W - M, 805, LINEINK, 0.8)

# titolo display
T(M, 748, "NON UN CORSO", "Display", 53, PAPER)
T(M, 702, "A CATALOGO.", "Display", 53, PAPER)
T(M, 656, "IL VOSTRO.", "Display", 53, ACID)

# sottotitolo
T(M, 628, "Non solo formazione: analizziamo i vostri processi e vi accompagniamo nel trovare", "Body", 11.5, BODYINK)
T(M, 612, "le soluzioni AI davvero utili — per l'azienda e per le persone.", "Body", 11.5, BODYINK)
...
hline(M, W - M, 300, LINEPAP, 0.8)
T(M, 280, "PERCHÉ È DIVERSO", "MonoB", 8, COBALT, tracking=1.6)
...
for k, (num, title, lines) in enumerate(diff):
    x = M + k*dcolw
    T(x, 250, num, "MonoB", 12, COBALT)
    c.setStrokeColor(COBALT); c.setLineWidth(2); c.line(x, 240, x + 20, 240)
    T(x, 220, title, "Head", 13, INK)
    for j, ln in enumerate(lines):
        T(x, 202 - j*12, ln, "Body", 9, GREY)
...
# eyebrow
T(M, 812, "IL METODO", "MonoB", 8, COBALT, tracking=1.6)
T(W - M, 812, "DALL'ASSESSMENT AI RISULTATI", "Mono", 8, GREY, align="r")
hline(M, W - M, 805, LINEPAP, 0.8)

# motivo a nodi (FIG. 01) in alto a destra
import math
nodes = [(470,760),(512,742),(498,712),(536,724),(548,700),(520,686)]
...
T(470, 672, "FIG. 01 — PROCESSI", "Mono", 6.5, GREY, tracking=0.6)

# titolo
T(M, 752, "COME", "Display", 52, INK)
T(M + pdfmetrics.stringWidth("COME ", "Display", 52), 752, "LAVORIAMO.", "Display", 52, COBALT)

# sottotitolo
T(M, 724, "Ogni percorso parte dai vostri processi reali — strumenti, documenti e mansioni", "Body", 11.5, GREY)
T(M, 708, "della vostra azienda. Niente pacchetti standard.", "Body", 11.5, GREY)

# --- il percorso ---
hline(M, W - M, 676, LINEPAP, 0.8)
T(M, 656, "IL PERCORSO — DALL'ASSESSMENT AI RISULTATI", "MonoB", 8, COBALT, tracking=1.4)
