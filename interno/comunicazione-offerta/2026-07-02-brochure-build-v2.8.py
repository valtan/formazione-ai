...
OUT="/sessions/inspiring-sleepy-brahmagupta/mnt/outputs/brochure_v28.pdf"
...
# QR code — riservato l'intero spazio a destra del footer (box Paper arrotondato + didascalia)
QR="/sessions/inspiring-sleepy-brahmagupta/mnt/formazione-ai/comunicazione/stampa/qr-afgp-ples.png"
qx1=547.3; qbox=88; qx0=qx1-qbox; qtop=737; qbot=qtop+qbox; qpad=8
c.setFillColorRGB(*WHITE)
c.roundRect(qx0,Y(qbot),qbox,qbox,8,stroke=0,fill=1)
c.drawImage(ImageReader(QR),qx0+qpad,Y(qbot-qpad),width=qbox-2*qpad,height=qbox-2*qpad,mask='auto')
mono(qx1,833,"Clicca o inquadra il QR code","GM",6.8,MIST,align="r",track=0.4)
